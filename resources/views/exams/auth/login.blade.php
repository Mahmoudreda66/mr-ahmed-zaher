@extends('exams.layouts.app', ['nav_transparent' => true])

@section('title')
تسجيل الدخول - الإختبارات
@endsection

@section('css')
<style>
	body {
		background-image: url('{{ asset("/dist/images/pexels-cottonbro-4778611.jpg") }}');
		...
		<div class="col-sm-7 col-12 mx-auto">
			<div class="bg-white rounded border shadow p-3">
				<div class="row">
					...
					<div class="col-6">
						<form action="{{ route('exams.login') }}" method="post"

let editGroupModal = new bootstrap.Modal(document.getElementById('editGroupModal')),
	...
	addTimeInGroupBtn = editGroupForm.querySelector('button#add-time'),
	groupInfo = null;

function removeTimeInGroup() {
	let removeBtns = editGroupForm.querySelectorAll('i.fa-times.position-absolute');
...
addTimeInGroupBtn.onclick = function () {
	...
	let weekDays = ['السبت', 'الأحد', 'الإثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة'],
		timesContainer = editGroupForm.querySelector('#times-container'),
...
function submitGroupForm () {
	let groupTimesEl = editGroupForm.querySelector('input#group_times'),
		daysSelects = editGroupForm.querySelectorAll('select'),
		timesInputs = editGroupForm.querySelectorAll('input[type="time"]'),
		daysValues = [],
		timesValues = [],
		errors = false;
